...
func TestNextDate(t *testing.T) {
	tbl := []nextDate{
		...
		{"15000156", "y", ""},
		{"ooops", "y", ""},
		{"16890220", "y", `16900220`}, //Изменена дата, т.к. если добавить к 20.02.1689 1 год, то должно быть 20.02.1690
		{"20250701", "y", `20260701`},
		{"20240101", "y", `20250101`},
		{"20231231", "y", `20241231`},
		{"20240229", "y", `20250301`},
		{"20240301", "y", `20250301`},
		{"20240113", "d", ""},
		{"20240113", "d 7", `20240120`}, //Изменена дата, т.к. если добавить к 13.01.2024 7 дней, то должно быть 20.01.2024
		{"20240120", "d 20", `20240209`},
		{"20240202", "d 30", `20240303`},
		{"20240320", "d 401", ""},
		{"20231225", "d 12", `20240106`}, //Изменена дата, т.к. если добавить к 25.12.2023 12 дней, то должно быть 06.01.2024
